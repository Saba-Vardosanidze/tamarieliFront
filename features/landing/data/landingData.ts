...
export const categories: Category[] = [
  { id: 1, name: "კულტურა და ხელოვნება", icon: Palette },
  { id: 2, name: "ლიტერატურა და ბიბლიოთეკა", icon: BookOpen },
  { id: 3, name: "მუსიკა და ხმა", icon: Music },
  { id: 4, name: "კინო და ვიზუალური ხელოვნება", icon: Film },
  { id: 5, name: "ცეკვა და მოძრაობა", icon: Activity },
  { id: 6, name: "განათლება და ინოვაცია", icon: Lightbulb },
  { id: 7, name: "დიასპორა და სამოქალაქო პლატფორმები", icon: Globe },
  { id: 8, name: "მედია და ხმა", icon: Megaphone },
];
