...
const HeroSection = async () => {
  ...
  return (
    <div className="flex justify-center items-center bg-white w-full">
      <div className={`flex flex-col items-center gap-[40px] bg-[length:100%_100%] bg-[url('${tamarieli}')] bg-no-repeat bg-center m-auto w-full max-w-[1440px] min-h-[323px] lg:min-h-[804px]`}>
