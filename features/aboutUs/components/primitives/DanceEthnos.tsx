...
const DanceEthos = () => {
  const t = useTranslations('danceEthos');
      ...
      <div className="z-10 relative mx-auto px-6 max-w-5xl">
        <div className="flex justify-center mb-12 lg:mb-16">
          <div className="relative bg-white/50 shadow-sm backdrop-blur-md p-4 border border-white/20 rounded-full">
            <Image
              src="/Images/headerImages/png/danceEthnos.png"
              alt="Dance Ethos Logo"
              width={180}
              height={180}
        ...
        <div className="flex flex-col items-center space-y-10 text-center">
          ...
          <div className="space-y-8 max-w-4xl">
            ...
            <div className="pt-8">
              <p className="inline-block pt-8 border-gray-200 border-t font-medium text-gray-900 text-2xl md:text-3xl uppercase tracking-[0.3em]">
                {t('tagline')}
              </p>
            </div>
          </div>
